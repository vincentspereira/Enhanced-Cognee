...
| TD-10 | NOTICE file missing (Apache 2.0 requirement) | HIGH | S | Project root |
...
### 11.1 - NOTICE File [Value: HIGH, Effort: S]
Required for legal compliance. See Section 9.2.
**Next action**: Create `NOTICE` file.
