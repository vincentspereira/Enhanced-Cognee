...
## Understanding the Contributor List
...
- **Vincent Pereira** (@vincentspereira)
  ...
  - Dynamic memory category system
...
- Show the evolution from original to enhanced version

### 📊 Contribution Breakdown

**Original Cognee** (2019-2025): ~90 contributors
- Core framework development
- ECL pipeline implementation
- Default database adapters (SQLite, LanceDB, Kuzu)
- Python SDK and CLI
...
## Original Cognee Core Team

The original Cognee project was created by:

- **Vasilije Markovic** (@topoteretes)
- **Andrej Milićević** (@andrejmilicevic)
- **Lazar Obradovic**
- **Jovan Pavlović**

And many other community contributors. See the full list at:
...
Your contributions will be clearly attributed and visible in this repository's history!
